...
<body>
	...
	<div class="main_mainContents__GXYBn">		
		...
		<div class="button_btnContainer__MjN_K"><button class="button_moreBtn__0aLKN">더 보기</button></div>
		<a class="btn btn-primary btn-lg" href="/clinicMarket/clinicDetail" role="button">더 보기</a>
		<hr class="popper_popperMenuDivider__j1QQj">
		<br/>
	</div>
