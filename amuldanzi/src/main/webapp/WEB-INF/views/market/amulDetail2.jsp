...
<meta name="description"
	content="Better Life for All. 건강한 식재료부터 믿을 수 있는 뷰티, 라이프스타일 상품까지. 나와 내 가족이 사고 싶은 상품을 판매합니다. 내일 아침 문 앞에서 만나요!" />
<meta name="keywords"
...
<link rel="icon" type="image/png" sizes="32x32"
	href="https://res.kurly.com/icons/favicon-32x23.png" />
...
<script
	src="https://res.kurly.com/_next/static/chunks/webpack-5eef108ed8fe3ad3.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/chunks/framework-f8115f7fae64930e.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/chunks/main-12ed125281f14b08.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/chunks/pages/_app-1f25ffcb6569f1a8.js"
	defer=""></script>
<script
...
<script
	...
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/chunks/63889-7aa995c99aedb013.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/chunks/67649-90150d944d793c31.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/chunks/59812-8532989b21e6dd06.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/chunks/63659-9845b2c6008dd79a.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/chunks/91207-cafd24cbd92c3dbb.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/chunks/24946-534ccb101b82310e.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/chunks/12046-6d7d0ee83ee63a65.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/chunks/55260-4205a67822cea794.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/chunks/89052-a63b6e01910fcfab.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/chunks/93605-a73e17f5aa8fd684.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/chunks/pages/cart-d9b3b9e77068d3aa.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/8f8mcSH_HWaUPDOlR07SV/_buildManifest.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/8f8mcSH_HWaUPDOlR07SV/_ssgManifest.js"
	defer=""></script>
<script
	src="https://res.kurly.com/_next/static/8f8mcSH_HWaUPDOlR07SV/_middlewareManifest.js"
	defer=""></script>
</head>
<body>
...
.css-fexq9b {
	...
	font-size: 12px;
				...
				<div class="css-fexq9b eo7pjfk4">
					<style data-emotion="css 14oah20">
.css-14oah20 {
	width: 150px;
	height: 100%;
}
...
.css-14oah20>span span {
	border-radius: 3px;
	height: 100%;
}
</style>
					<div radius="3" width="150" class="css-14oah20 e1msm9zb0">
						<span aria-live="polite" aria-busy="true"><span
							class="react-loading-skeleton">‌</span><br /></span>
					</div>
...
.css-oyffzd {
	...
	cursor: pointer;
						...
						<a class="css-oyffzd eo7pjfk2">고객센터
							<style data-emotion="css 1uqkit7">
.css-1uqkit7 {
...
</style> <span class="css-1lrerrk eo4j3y50"></span>
						</a>
...
.css-j0ug0x:not(:last-of-type):after {
	content: '';
	position: absolute;
	width: 1px;
	height: 14px;
	...
	background-color: #e2e2e2;
						...
						<style data-emotion="css 1sia941">
.css-1sia941 {
	-webkit-flex-shrink: 0;
	-ms-flex-negative: 0;
	flex-shrink: 0;
...
.css-1sia941.active, .css-1sia941:hover {
	font-weight: 500;
	color: #5f0080;
}

.css-1sia941:not(:last-of-type):after {
	content: '';
	position: absolute;
	width: 1px;
	height: 14px;
...
.css-11ntk83:-webkit-autofill, .css-11ntk83:-webkit-autofill:hover,
	.css-11ntk83:-webkit-autofill:focus, .css-11ntk83:-webkit-autofill:active
	{
	...
	transition: background-color 5000s ease-in-out 0s;
							...
							<input id="gnb_search" placeholder="검색어를 입력해주세요" value=""
								required="" class="css-11ntk83 e1493ofl3" />
...
.css-19lw9rr .MuiTooltip-tooltip {
	...
	margin: 0 !important;
							...
							<style data-emotion="css 1n4p7us">
.css-1n4p7us {
	width: 36px;
	height: 36px;
	margin-right: 20px;
...
.css-231fw3:hover {
	background-image:
		url(data:image/svg+xml;base64,);
							...
							<button class="css-231fw3 etxxzpc0" aria-label="찜하기"
								type="button"></button>
...
.css-g25h97:hover {
	background:
		url(data:image/svg+xml;base64,);
			...
			<style data-emotion="css 19ndp9a">
.css-19ndp9a {
	min-width: 1050px;
	letter-spacing: -0.3px;
	background-color: #fff;
...
.css-59mmhh {
	...
	text-align: center;
						...
						<li class="css-59mmhh e17w4cfr4"><style
								data-emotion="css 1xyu7j9">
.css-1xyu7j9 {
...
</style> <span class="css-1xyu7j9 e17w4cfr2">신상품</span></li>
...
.css-s5xdrg {
	...
	align-items: center;
					...
					<div class="css-s5xdrg e17w4cfr0">
						<a
							href="/shop/event/kurlyEvent.php?htmid=event/delivery_search/delivery_search"><style
								data-emotion="css dnwaeo">
.css-dnwaeo {
	height: 32px;
	padding: 6px 16px;
	border-radius: 18px;
...
.css-1s2o3jp {
	...
	color: #5f0080;
								...
								<span class="css-1s2o3jp e1mmzaxa0">샛별・택배</span> 배송안내
							</div></a>
					</div>
				</div>
			</div>
...
.css-1vf8o8s {
	...
	color: #ddd;
							...
							<label class="css-1vf8o8s e1dcessg3" disabled=""><style
									data-emotion="css agvwxo">
.css-agvwxo {
	overflow: hidden;
	position: absolute;
	clip: rect(0, 0, 0, 0);
...
</style> <input type="checkbox" disabled="" class="css-agvwxo e1dcessg2" />
								...
								<div class="css-79hxr7 e1dcessg1">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
										...
										<path d="M7 12.6667L10.3846 16L18 8.5" stroke="#ddd"
											stroke-width="1.5" stroke-linecap="round"
											stroke-linejoin="round"></path></svg>
								</div> <span>전체선택 (0/0)</span></label><span class="css-454d5e e149z641"></span>
							<button disabled="" class="css-0 e149z640">선택삭제</button>
						</div>
					</div>
				</div>
...
.css-oft680 {
	...
	border-bottom: 0;
						...
						<div class="css-oft680 e15fcx0p3">
							<style data-emotion="css 1guaarh">
.css-1guaarh {
	padding-left: 24px;
	font-size: 16px;
	font-weight: 500;
	line-height: 20px;
	background:
		url('https://res.kurly.com/pc/service/cart/2007/ico_location.svg') 0
		50% no-repeat;
...
.css-iba1ml+button span>img {
	vertical-align: top;
}
</style>
								<p class="css-iba1ml e1321nl41">
									<em>배송지를 등록</em>하고<br />
									<style data-emotion="css 1bmnxg7">
.css-1bmnxg7 {
	white-space: nowrap;
}
</style>
								...
								<style data-emotion="css 12e7k5j">
.css-12e7k5j img {
	margin-right: 0;
}
</style>
								<style data-emotion="css 1bh2ea0">
.css-1bh2ea0 {
	display: block;
	padding: 0 10px;
	text-align: center;
...
.css-1bh2ea0 img {
	margin-right: 0;
								...
								<button class="css-1bh2ea0 e4nu7ef3" type="button" height="36"
									radius="3">
									<style data-emotion="css nytqmg">
.css-nytqmg {
	display: inline-block;
	font-size: 16px;
	font-weight: 500;
									...
									<span class="css-nytqmg e4nu7ef1"><style
											data-emotion="css 1m3kac1">
.css-1m3kac1 {
	display: inline-block;
	width: 20px;
	height: 20px;
...
</style> <img src="https://res.kurly.com/pc/service/cart/2007/ico_search.svg"
...
</style> <span class="css-hfgifi ea1mry72">원</span>
								</span>
							</div>
...
.css-da7gr8 {
	...
	text-align: right;
								...
								<span class="css-da7gr8 eepcpbj2"><style
										data-emotion="css xmbce4">
.css-xmbce4 {
	font-size: 20px;
	font-weight: 700;
	line-height: 28px;
}
</style> <strong class="css-xmbce4 eepcpbj0">0</strong>
...
</style> <span class="css-aro4zf eepcpbj1">원</span></span>
							</div>
						</div>
...
.css-id8jk6>div>div:first-of-type {
	width: 100px;
	height: 100px;
}
</style>
							<div class="css-id8jk6 e1mybczi0">
								<style data-emotion="css rbk7g9">
.css-rbk7g9 {
	position: fixed;
	top: 0;
	left: 0;
	...
	z-index: 999;
								...
								<div width="24" height="24" class="css-rbk7g9 euwlw0z1">
...
.css-17j3ye5 {
	...
	transform: translate(-50%, -50%);
									...
									<div class="css-17j3ye5 euwlw0z0">
										<span><div style="width: 100%; height: 100%"></div></span>
									</div>
								</div>
							</div>
...
.css-7s0nna:before {
	...
	content: '';
								...
								<li class="css-7s0nna ejr204i0">[주문완료] 상태일 경우에만 주문 취소
									가능합니다.</li>
								<li class="css-7s0nna ejr204i0">[마이컬리 &gt; 주문내역 상세페이지] 에서
									직접 취소하실 수 있습니다.</li>
							</ul>
						</div>
					</div>
...
.css-9jqcug {
	...
	line-height: 40px;
						...
						<strong class="css-9jqcug eam2qm58">1644-1107
							<style data-emotion="css 1uz1ro8">
.css-1uz1ro8 {
	margin-left: 8px;
	font-weight: normal;
	font-size: 16px;
}
</style> <span class="css-1uz1ro8 eam2qm59">월~토요일 오전 7시 - 오후 6시</span>
						</strong>
...
.css-slkv2p:first-of-type {
	margin-left: 0;
							...
							<li class=" css-slkv2p e13nap1l1"><style
									data-emotion="css 1tfhwyj">
.css-1tfhwyj {
	font-size: 14px;
	line-height: 18px;
}
</style> <a href="/introduce" target="_self" class="css-1tfhwyj e13nap1l0">컬리소개</a></li>
...
.css-bz7mfs {
	...
	margin-bottom: 40px;
						...
						<div class="css-bz7mfs ebj6vxr2">
							법인명 (상호) : 주식회사 컬리
							<style data-emotion="css 1ekjygq">
.css-1ekjygq {
	padding-left: 4px;
}
...
.css-1ekjygq:after {
	...
	vertical-align: top;
							...
							<span class="css-1ekjygq ebj6vxr1"></span> 사업자등록번호 : 261-81-23567
							<style data-emotion="css 1tby8gd">
.css-1tby8gd {
	margin-left: 3px;
	color: #5f0080;
}
							...
							<a
								...
								확인</a><br />통신판매업 : 제 2018-서울강남-01646 호<br />주소 : 서울특별시 강남구 테헤란로
							133, 18층(역삼동) <span class="css-1ekjygq ebj6vxr1"></span> 대표이사 :
							김슬아<br />채용문의 :<a href="mailto:recruit@kurlycorp.com"
...
.css-175n8cp {
	...
	color: #999;
			...
			<div class="css-175n8cp etk3uz81">
				...
				책임을 부담하지 않습니다.
				<style data-emotion="css 1vhhy2d">
.css-1vhhy2d {
	display: block;
	padding-top: 7px;
	font-style: normal;
				...
				<em class="css-1vhhy2d etk3uz80">© KURLY CORP. ALL RIGHTS
					RESERVED</em>
			</div>
		</div>
	</div>
	<script id="__NEXT_DATA__" type="application/json">{"props":{"pageProps":{}},"page":"/cart","query":{},"buildId":"8f8mcSH_HWaUPDOlR07SV","assetPrefix":"https://res.kurly.com","nextExport":true,"autoExport":true,"isFallback":false,"scriptLoader":[]}</script>
</body>
</html>