...
<body>
    <form enctype="multipart/form-data" action="/market/jungoSave" method="post">
        <div class="question_questionContainer__xQp_P">
            <div class="question_questionContent__Y4VxA">
                ...
                <div class="question_radioWrap__WZ6ME">
                    <div>
                        <input type="radio" id="공지" value="공지" checked="공지">
                        <label for="공지">중고마켓</label>
                    </div>
                </div>
                <div>
                    <div>
                    ...
                    <div>
                        <span class="question_questionCategory__1QDx6">가격</span><span class="question_questionMark__AykT_">*</span>
                    </div>
                    <input placeholder="숫자만 입력해주세요" class="question_titleInput__S7Isd" name="goodsPrice">
                    <div class="question_alertText__WnxqW"></div>
                    <!--  -->
                </div>
                <div class="question_questionInputWrapper__fGaar">
                    <textarea placeholder="5자 이상의 글 내용을 입력해주세요" class="question_questionInput___Mb57" name="goodsContent"></textarea>
                    <div class="question_alertText__WnxqW"></div>
                </div>
                <div class="question_fileInputWrapper__d9gmU">
                    ...
                    <input id="uploadFile" name="file" type="file" multiple="" accept="image/jpg,image/png,image/jpeg,image/gif" style="display: none;">
                    ...
                    <span class="question_imgDesc__SQFui">업로드 용량: 10MB, 첨부 파일의 경우 사진 1개만 업로드 가능합니다.</span>
                </div>
                <div class="question_thumbnailText__h45xg">
                    <ul>
                        <li>사진을 업로드 시,업로드 용량이 초과되면 사진이 업로드 되지 않을 수 있습니다.</li>
                    </ul>
                </div>
