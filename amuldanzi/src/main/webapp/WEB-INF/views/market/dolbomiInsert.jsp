...
<body>
    <form enctype="multipart/form-data" action="/market/dolbomiSave" method="post">
        <div class="question_questionContainer__xQp_P">
            <div class="question_questionContent__Y4VxA">
                ...
                <div>
                    ...
                    <div>
                        <span class="question_questionCategory__1QDx6">시급</span><span class="question_questionMark__AykT_">*</span>
                    </div>
