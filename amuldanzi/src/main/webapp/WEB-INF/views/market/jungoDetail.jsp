...
<link rel="preload" href="/chunks/css/market/marketDetail.css" as="style" />
<link rel="stylesheet" href="/chunks/css/market/marketDetail.css" />

<title>애물단지 중고마켓</title>
<link rel="canonical" href="https://www.daangn.com/articles/611832877" />


<link rel="stylesheet"
	href="/chunks/css/market/jungoDetail.css"
	media="all" />
<script
	...
	<article id="content" data-id="611832877">
		...
		<section id="article-description">
			<h1 property="schema:name" id="article-title"
				style="margin-top: 0px;">판매 제품명</h1>
			<p id="article-category">
				품목 카테고리 ∙
				<time> 현 시간 - 글 올린시간 </time>
			</p>
			...
			<p id="article-counts">관심 0 ∙ 조회 0</p>
		</section>
	</article>
