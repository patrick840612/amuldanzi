<div class="community_loungeLeftContent__wnv1Z">
	...
	<div class="community_loungeRightContainer__cK_7p">
		<div>
			<button
				class="MuiButton-root MuiButton-contained MuiButton-containedSecondary MuiButton-sizeMedium MuiButton-containedSizeMedium MuiButtonBase-root  css-k505d4"
				tabindex="0" type="button">
				<span
					class="MuiButton-startIcon MuiButton-iconSizeMedium css-1l6c7y9"><svg
						class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-vubbuv"
						focusable="false" aria-hidden="true" viewBox="0 0 24 24"
						data-testid="CreateOutlinedIcon">
						<path
							d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM5.92 19H5v-.92l9.06-9.06.92.92L5.92 19zM20.71 5.63l-2.34-2.34c-.2-.2-.45-.29-.71-.29s-.51.1-.7.29l-1.83 1.83 3.75 3.75 1.83-1.83c.39-.39.39-1.02 0-1.41z"></path></svg></span>글쓰기<span
					class="MuiTouchRipple-root css-w0pj6f"></span>
			</button>
		</div>
		<div class="community_loungeRightContent__KR4MF">
			<div class="community_sortTitle__d5jzb">동물유형</div>
			<div class="community_checkboxwrap__Y1wRC">
				<input type="checkbox" name="a" id="a"><label for="a"
					class="community_checkLabel___E5NG">강아지</label>
			</div>
			<div class="community_checkboxwrap__Y1wRC">
				<input type="checkbox" name="a" id="a"><label for="a"
					class="community_checkLabel___E5NG">고양이</label>
			</div>
			<div class="community_checkboxwrap__Y1wRC">
				<input type="checkbox" name="a" id="a"><label for="a"
					class="community_checkLabel___E5NG">소동물</label>
			</div>
			<div class="community_checkboxwrap__Y1wRC">
				<input type="checkbox" name="a" id="a"><label for="a"
					class="community_checkLabel___E5NG">기타</label>
			</div>
			<button class="community_applyBtn__X04Hi">적용</button>
		</div>
	</div>