$(document).ready(function(){
	...
	function loadImage(){
		...
		backgroundImage.src = "/pexels-mudassir-ali-2680270.jpg";
		
		catImage = new Image();
		catImage.src="/icons8-cat-26.png";
		
		bulletImage = new Image();
		bulletImage.src="/icons8-bullet-16.png";
		
		enemyImage = new Image();
		enemyImage.src="/icons8-cute-mouse-48.png";
		
		gameOverImage = new Image();
		gameOverImage.src="/gameoverimages.jpg";
		
		collisionImage = new Image();
		collisionImage.src="/icons8-collision-48.png";
	}
